            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#tambahMasukModal"><i class="fa fa-plus"></i>
                ...
                <table id="table-data" class="table table-striped table-white">
                    ...
                    <tbody>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" id="btn-edit-jadwal" class="btn btn-success"
                                            ...
                                            onclick="deleteConfirmation('{{ $row->id }}', '{{ $row->kode_kas_keluar }}' )"><i class="fa fa-times"></i></button>
                                            <button class="btn btn-xs"></button>
                        ...
                        <tfoot>
    <tr>
     <th colspan="5">Total Kas Keluar</th>
     <th colspan="3"> @foreach($total as $tot) RP. {{$tot->total_kas_keluar}}
    @endforeach</th>
    </tr>
  </tfoot>
                    </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('bensek.keluar.submit') }}" enctype="multipart/form-data">
                        @csrf
     ...
     <div class="modal fade" id="editMasukModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('bensek.keluar.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
...
function formatRupiah(angka, prefix)
{
    ...
    return prefix == undefined ? rupiah : (rupiah ? 'Rp. ' + rupiah : '');
            ...
            $(document).on('click', '#btn-edit-jadwal', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ url('admin/kas_keluar/ajaxadmin/dataKeluar') }}/" + id,
                    dataType: 'json',
                    success: function(res) {
                        ...
                        $('#edit-kode').val(res.kode_kas_keluar);
                        $('#edit-id').val(res.id);
                    },
                });
            });
